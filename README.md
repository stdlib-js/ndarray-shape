...
```javascript
import shape from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-shape@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-shape/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/ndarray-shape/actions/workflows/test.yml?query=branch:v0.2.3
